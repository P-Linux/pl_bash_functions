...
#
#       so_prepare_src_matrix _SCRMTX _SOURCES_1 _CHECKSUMS_1 "${_PKGFILE_FULLPATH}_1"
#       so_prepare_src_matrix _SCRMTX _SOURCES_2 _CHECKSUMS_2 "${_PKGFILE_FULLPATH}_2" "${_SRCDEST_DIR}_2"
#       so_prepare_src_matrix _SCRMTX _SOURCES_3 _CHECKSUMS_3 "${_PKGFILE_FULLPATH}_3" "${_SRCDEST_DIR}_3"
#******************************************************************************************************************************
